...
{
    //Уровни сложности:
    //1. Ячейка для хода выбирается рандомно. Потом производится проверка свободности ячейки
    //2. Дебют малоагресивный что за О что за Х. Приоритет - постоить свою тройку. 
    //   25% шанс среагировать на угрозу выигрыша игрока (через подстановку хода и winCheck),
    //   Если нейтрализация угрозы достраивает свою строку - шанс среагировать 70%.
    //3. Дебют агресивный. Взятие центра первым ходом если за Х. Реагирует на угрозы игрока всегда 
    //   (через подстановку хода и winCheck). Строит свою тройку. При взятии игроком центра и 
    //   любого угла - сводит в ничью взятием 2х углов
    //   и любой клетки второй строки. 
